...
public class TestDrive extends RobotDriveBase implements Sendable, AutoCloseable {
  ...
  public TestDrive(MotorController leftMotor, MotorController rightMotor) {
  ...
  public TestDrive(DoubleConsumer leftMotor, DoubleConsumer rightMotor) {
  ...
  public void TarcadeDrive(double xSpeed, double zRotation) { /// needs improovement
    if(zRotation > 0.2) {
        tankDrive(0, zRotation);
    } else if(zRotation < -0.2) {
        tankDrive(-zRotation, 0);
    } else if(xSpeed > 0.2) {
